...
- 参照: CLAUDE.md「Frontend」節 / `.thread/1/plan.md`（AC-9〜AC-14 / AC-18）/ `.thread/1/adr.md`（ADR-005 / 007 / 016 / 017 / 028）/ `spec/pages/index.md`（共通レイアウト・P-01 / 02 / 03 / 04 / 13）/ `spec/inventory/frontend.md` / `spec/design/{index,tokens}.md` / `spec/design/pages/{login,signup,password-reset,timeline,settings}.html`
