...
**前提:** ラウンド2。`.thread/1/review/review-001-adapters.md` の W-001〜W-008 と `.thread/1/review/triage.md` の判定を踏まえ、解消確認 + ゼロベースの再レビュー。
**参照:** `.thread/1/plan.md`（AC-5 / AC-6 / AC-7）、`.thread/1/adr.md`（ADR-003 / 004 / 008 / 014 / 015）、`spec/database/index.md#users`、`spec/domains/identity.md`
