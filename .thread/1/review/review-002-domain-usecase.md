...
参照した設計文書: `.thread/1/plan.md`（AC-1〜AC-4 / AC-8）、`.thread/1/adr.md`（ADR-001〜032）、`.thread/1/review/review-001-domain-usecase.md`、`.thread/1/review/triage.md`
...
- **[W-003]** `progress.md` の残存課題が R1 修正後の実装と矛盾したまま残っている
  - 場所: `.thread/1/progress.md:9-13`（「1. `loginWithPassword` のタイミングサイドチャネル」）
