...
export function getRouter() {
  return createRouter({
    ...
    // The shell scrolls its sheet, not the window
    // (.issue/1/adr.md ADR-030), and scroll restoration only resets the
    // window by default — a new screen would otherwise open at the
    // previous one's offset. Naming the element also
