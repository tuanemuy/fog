...
describe("requireUserId", () => {
  ...
  // (.issue/1/adr.md ADR-038 — it replaces ADR-031's "the guard is the one
  // authority", because the guard runs too late for a streaming route).
  // Router-level invalidation cannot reach the browser's history /
