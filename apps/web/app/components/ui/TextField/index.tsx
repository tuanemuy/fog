...
const INPUT =
  "rounded-(--radius-md) [border:var(--border-input)] bg-bg-card p-(--pad-input) font-base text-base text-neutral-900 transition-colors placeholder:text-neutral-400 focus:border-primary focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus aria-[invalid=true]:border-error";
