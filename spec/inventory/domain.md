...
| DOM-identity-029 | PasswordHasher.hash | spec/domains/identity.md#PasswordHasher | PlainPassword → PasswordHash。アルゴリズムはアダプター責務、失敗は SystemError。**トランザクションの外で動くため Promise 契約のまま残る** |
